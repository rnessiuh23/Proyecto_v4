...
if(!$paternoUsu) {
  ...
  if(empty($errores)) {
    // INSERTAR EN LA BD
  $query = "INSERT INTO Usuarios (nombreUsu, paternoUsu, maternoUsu, correoUsu, contrasenaUsu, rol) VALUES ('$nombreUsu', '$paternoUsu', '$maternoUsu', '$correoUsu', '$contrasenaUsu', '$rol' )";

  $resultado = mysqli_query($db, $query);

  if($resultado) {

    header('Location: ../formularios/registrarUsuarios.php?resultadoURL=1');
  } 
}
  }
...
<body class="g-sidenav-show bg-gray-100">
  ...
  Swal.fire({
    ...
    html: '<p>¿Desea agregar otro usuario?</p>',
    icon: 'success',
    ...
    if (result.isConfirmed) {
      window.location.href = "../formularios/registrarUsuarios.php";
    } else {
  ...
  <form method="POST" action="../formularios/registrarUsuarios.php">

  
    <div class="col-md-6">
      <div class="form-group">
        <input type="text" class="form-controlNone text-uppercase" name="idUsuarios" id="idUsuarios" placeholder="" value="<?php echo $idUsuarios; ?>" disabled>
        <?php if(isset($errores['idUsuarios'])): ?>
          <div class="message-error" id="idUsuarios-error" id="idUsuarios-error">
  ...
  <div class="row"> 
    <div class="col-md-6">
      ...
      <label for="nombre">Nombre</label>
        <input type="text" class="form-control text-uppercase" name="nombreUsu" id="nombreUsu" placeholder="Ej: Gab0R3yes12" value="<?php echo $nombreUsu; ?>" autofocus>
    ...
    <div class="col-md-6">
      ...
      <label for="correoUsu">Correo</label>
        <input type="text" class="form-control" name="correoUsu" id="correoUsu" placeholder="usuario@correo.com" value="<?php echo $correoUsu; ?>">
  ...
  <div class="col-md-6">
      ...
      <label for="contrasenaUsu">Contraseña</label>
        <input type="password" class="form-control" name="contrasenaUsu" id="contrasenaUsu" placeholder="**********" value="<?php echo $contrasenaUsu; ?>">
