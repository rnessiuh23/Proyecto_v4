...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if($resultado) {
    ...
    header('Location: ../formularios/registrarAlumnos.php?resultadoURL=1');
  } 
}
  }
...
<body class="g-sidenav-show bg-gray-100">
  ...
  Swal.fire({
    ...
    html: '<p>¿Desea agregar otro alumno?</p>',
    icon: 'success',
    ...
    if (result.isConfirmed) {
      window.location.href = "../formularios/registrarAlumnos.php";
    } else {
  ...
  <form method="POST" action="../formularios/registrarAlumnos.php">
  <div class="row">
    <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <select name="carrera" id="carrera" class="form-select text-uppercase" aria-label="Default select example">
  ...
  <script defer src="../assets/js/soft-ui-dashboard.min.js?v=1.0.7"></script>
  <!-- Incluye SweetAlert2 JS -->
  <script defer src="https://cdn.jsdelivr.net/npm/sweetalert2@11.1.5/dist/sweetalert2.all.min.js"></script>
