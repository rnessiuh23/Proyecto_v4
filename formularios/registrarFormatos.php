...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(!$fecRegistro ) {
    $errores['fecRegistro'][] = "Seleccione una fecha";
  }
  ...
  if(empty($errores)) {
    // INSERTAR EN LA BD
  $query = "INSERT INTO Formatos (fecRegistro, hora, ss, fecInicio, fecTermino, carta, primerInf, segundoInf, tercerInf, finalInf, terminacion, evaluacion, solicitud, observaciones) 
  VALUES ('$fecRegistro', '$hora', '$ss', '$fecInicio', '$fecTermino', '$carta', '$primerInf', '$segundoInf', '$tercerInf', '$finalInf', '$terminacion', '$evaluacion', '$solicitud', '$observaciones')";
  ...
  if($resultado) {
    ...
    header('Location: ../formularios/registrarFormatos.php?resultadoURL=1');
  } 
}
  }
...
<body class="g-sidenav-show bg-gray-100">
  ...
  Swal.fire({
    ...
    html: '<p>¿Desea agregar otro formato?</p>',
    icon: 'success',
    ...
    if (result.isConfirmed) {
      window.location.href = "../formularios/registrarFormatos.php";
    } else {
  ...
  <form method="POST" action="../formularios/registrarFormatos.php">
...
<div class="col-md-6">
      ...
      <label for="fecRegistro">Fecha de Registro</label>
        <input type="date" class="form-control text-uppercase" name="fecRegistro" id="fecRegistro" placeholder="" value="<?php echo $fecRegistro; ?>">
    ...
    <div class="col-md-6">
      ...
      <label for="hora">Hora</label>
        <input type="time" class="form-control" name="hora" id="hora" placeholder="" value="<?php echo $hora; ?>">
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <select name="carta" id="carta" class="form-select text-uppercase" aria-label="Default select example">
        <option value="" selected>-- Selecciona --</option>
        <option <?php echo $carta === "Entregado" ? 'selected' : '' ?> value="Entregado">Entregado</option>
        <option <?php echo $carta === "Pendiente" ? 'selected' : '' ?> value="Pendiente">Pendiente</option>
        <option <?php echo $carta === "No Entregado" ? 'selected' : '' ?> value="No Entregado">No Entregado</option>
      </select>
  ...
  <div class="col-md-6">
      <div class="form-group">
      <label for="terminacion">Carta de Termino</label>
    ...
    <div class="col-md-6">
      <div class="form-group">
      <label for="evaluacion">Hoja de Evaluacion</label>
